...
**完成状态**：✅ 已完成激进清理（2026-05-12）

- 删除 `lib/export/exporters/` 目录
- 删除 `lib/export/svgProcessor.ts`
- 删除 `lib/exportUtils.ts`
- `lib/export/index.ts` 只导出深度模块
...
- ❌ `lib/exportUtils.ts`（传递模块）→ ✅ 已删除（2026-05-12）
- ❌ `lib/export/exporters/*.ts`（薄包装）→ ✅ 已删除（2026-05-12）
- ❌ `lib/export/svgProcessor.ts`（废弃委托）→ ✅ 已删除（2026-05-12）
