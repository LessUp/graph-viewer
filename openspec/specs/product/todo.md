...
- [x] 确认 GitHub Pages 首页、README、docs、OpenSpec 对”演示版 vs 完整版”的描述一致
- [x] 确认 AI 指令文件只保留项目必要规则，不复制通用模板
- [x] 确认 CI/CD 只服务主线质量门禁和 Pages 部署
- [x] 确认依赖升级不再自动生成长期维护分支
- [x] 确认最终分支和 worktree 状态干净
